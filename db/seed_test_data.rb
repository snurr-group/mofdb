...
if Rails.env.test?
  ...
  m2 = Mof.create!(database: d1, batch: b, surface_area_m2cm3: 2000, surface_area_m2g: 2000, mofid: "[Eu].[O-]C(=O)C(=O)[O-].[O-]C(=O)C1=C([N]C=N1)C(=O)[O-].[O-]C(=O)C1=NC=N[C]1C(=O)[O-].[O-]C(=O)C1=N[C]N=C1C(=O)[O-].[Zn] MOFid-v1.ERROR.cat0",
                             mofkey: "Fe.PVNIIMVLHYAWGP.MOFkey-v1.ERROR", name: "test_mof2", void_fraction: 0.9, pld: 30, lcd: 40, database: d2, cif: load_cif(2))
  m3 = Mof.create!(database: d2, batch: b, surface_area_m2cm3: 3001, surface_area_m2g: 3000, name: "test_mof3", void_fraction: 0.99, pld: 40, lcd: 50, database: d1, cif: load_cif(3))
