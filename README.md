...
This repository is only half of mofdb 1/3. Another 1/3 is mofdb-interface, a python class that can be used to easily parse
...
Final third is the [mofdb_client python3 package](https://github.com/n8ta/mofdb-client) that wraps the API and can be used by anyone to access mofdb easily.
...
It tests all api params except bulk/cif and exercises a decent bit of the ui.
